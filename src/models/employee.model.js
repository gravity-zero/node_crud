...
//NOTE
//FIXME 
//TODO 1 Créer compteur d'update, birthday, ambition.
//TODO 2 Interface front en vuejs
//TODO 3 Regrouper les informations du json array Title=>object Title=>array Title  
//NOTE
    ...
    dbConn.query("UPDATE employees SET first_name=?,last_name=?,email=?,phone=?,organization=?,designation=?,salary=? WHERE id = ?",
     ...
     function (err, res) {
      ...
      Employee.delete = function(id, result){
        dbConn.query("DELETE FROM employees WHERE id = ?",
         [id], 
         function (err, res) {
           if(err) { 
              console.log("error: ", err);
